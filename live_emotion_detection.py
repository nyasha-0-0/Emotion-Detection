...
def live_detection(model, scaler, model_name):
    ...
    print("Position your eyes in the rectangle")
    ...
    while True:
        ...
        if key == ord('q'):
            ...
            cv2.imwrite(f'captured_emotion_{emotion}_{timestamp}.png', frame)
...
def test_single_image(model, scaler, image_path):
    ...
    actual_emotion = os.path.basename(os.path.dirname(image_path)) if os.path.dirname(image_path) else "Unknown"
...
if __name__ == "__main__":
    ...
    # Cross-validation (using original X before split)
    ...
    while True:
        ...
        if choice == '1':
            ...
            if test_images:
                ...
                print(f"No images found in {test_emotion} folder")
